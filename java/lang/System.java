...
public final class System
{
	...
	static
	{
		...
		if (defaultProperties.get("gnu.classpath.home.url") == null)
			defaultProperties.put("gnu.classpath.home.url", "file://"
		...
		defaultProperties.put("gnu.java.io.encoding_scheme_alias.latin9",
				"8859_9");
		defaultProperties
				.put("gnu.java.io.encoding_scheme_alias.UTF-8", "UTF8");
		defaultProperties
				.put("gnu.java.io.encoding_scheme_alias.utf-8", "UTF8");
		...
		//test
//		VMSystem.testObject(defaultProperties
//				.get("line.separator"));
	}
	...
	//private static Properties properties = (Properties) Runtime.defaultProperties
			//.clone();
	
	
	
	private static Properties properties = Runtime.defaultProperties;
	// private static Properties properties = Runtime.defaultProperties;
//	static
//	{
//		VMSystem.testObject(properties
//				.get("line.separator"));
//	}
	 ...
	 * <dl>
	 * gnu.classpath.home
	 * <dd>Path to the classpath libraries.
	 * <dl>
	 * gnu.classpath.version
	 * <dd>Version of the classpath libraries.
	 * <dl>
